...
Before you set up your local development environment, **read our [Building Guidelines](https://docs.Circle-browser.app/guides/building)**. Skipping them can lead to avoidable build errors.
